...
Route::get('/compras', [ContabilidadController::class, 'showCompraForm'])->name('compras.form');
//Route::post('/compras', [ContabilidadController::class, 'storeCompra']);
Route::post('/compras', [ContabilidadController::class, 'storeCompra'])->name('compras.store');
